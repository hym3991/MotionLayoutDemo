...
public abstract class KeyCycleOscillator {
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            ...
            double[][] values = (double[][]) Array.newInstance(Double.TYPE, count, 2);
    ...
    static class CycleOscillator {
        ...
        public double getValues(float time) {
            if (this.mCurveFit != null) {
                ...
                this.mSplineValueCache[0] = (double) this.mOffset[0];
                this.mSplineValueCache[1] = (double) this.mValues[0];
            }
        ...
        public double getSlope(float time) {
            ...
            return this.mSplineSlopeCache[0] + (this.mSplineSlopeCache[1] * this.mOscillator.getValue((double) time)) + (this.mSplineValueCache[1] * this.mOscillator.getSlope((double) time));
        }
        ...
        public void setup(float pathLength) {
            ...
            double[][] splineValues = (double[][]) Array.newInstance(Double.TYPE, this.mPosition.length, 2);
            ...
            for (int i = 0; i < splineValues.length; i++) {
                ...
                for (int j = 0; j < this.mValues.length; j++) {
                    splineValues[j][1] = (double) this.mValues[j];
                }
