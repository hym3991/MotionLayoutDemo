...
public class VelocityMatrix {
    ...
    public void applyTransform(float locationX, float locationY, int width, int height, float[] mAnchorDpDt) {
        ...
        float offx = 2.0f * (locationX - 0.5f);
        float offy = 2.0f * (locationY - 0.5f);
        ...
        mAnchorDpDt[0] = dx3 + (((float) ((((double) (((float) (-width)) * offx)) * Math.sin((double) r)) - (((double) (((float) height) * offy)) * Math.cos((double) r)))) * dr);
        mAnchorDpDt[1] = dy3 + (((float) ((((double) (((float) width) * offx)) * Math.cos((double) r)) - (((double) (((float) height) * offy)) * Math.sin((double) r)))) * dr);
    }
}
