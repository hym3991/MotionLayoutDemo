...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(R.styleable.Constraint_progress, PROGRESS);
        ...
        public void fillFromAttributeList(Context context, AttributeSet attrs) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    ...
                    case 50:
                    case 51:
                    case ConstraintSet.TRANSLATION_Y /*{ENCODED_INT: 52}*/:
                    case ConstraintSet.TRANSLATION_Z /*{ENCODED_INT: 53}*/:
                    case ConstraintSet.ROTATION /*{ENCODED_INT: 60}*/:
                    case ConstraintSet.ANIMATE_RELATIVE_TO /*{ENCODED_INT: 64}*/:
                    case ConstraintSet.TRANSITION_EASING /*{ENCODED_INT: 65}*/:
                    case ConstraintSet.DRAW_PATH /*{ENCODED_INT: 66}*/:
                    case ConstraintSet.TRANSITION_PATH_ROTATE /*{ENCODED_INT: 67}*/:
                    case ConstraintSet.PROGRESS /*{ENCODED_INT: 68}*/:
                    case ConstraintSet.VISIBILITY_MODE /*{ENCODED_INT: 78}*/:
                    case ConstraintSet.MOTION_STAGGER /*{ENCODED_INT: 79}*/:
                    default:
                        Log.w(ConstraintSet.TAG, "Unknown attribute 0x" + Integer.toHexString(attr) + "   " + mapToConstant.get(attr));
                        break;
                    case ConstraintSet.WIDTH_DEFAULT /*{ENCODED_INT: 54}*/:
                        this.widthDefault = a.getInt(attr, this.widthDefault);
                        break;
                    case ConstraintSet.HEIGHT_DEFAULT /*{ENCODED_INT: 55}*/:
                        this.heightDefault = a.getInt(attr, this.heightDefault);
                        break;
                    case ConstraintSet.WIDTH_MAX /*{ENCODED_INT: 56}*/:
                        this.widthMax = a.getDimensionPixelSize(attr, this.widthMax);
                        break;
                    case ConstraintSet.HEIGHT_MAX /*{ENCODED_INT: 57}*/:
                        this.heightMax = a.getDimensionPixelSize(attr, this.heightMax);
                        break;
                    case ConstraintSet.WIDTH_MIN /*{ENCODED_INT: 58}*/:
                        this.widthMin = a.getDimensionPixelSize(attr, this.widthMin);
                        break;
                    case ConstraintSet.HEIGHT_MIN /*{ENCODED_INT: 59}*/:
                        this.heightMin = a.getDimensionPixelSize(attr, this.heightMin);
                        break;
                    case CIRCLE /*{ENCODED_INT: 61}*/:
                        this.circleConstraint = ConstraintSet.lookupID(a, attr, this.circleConstraint);
                        break;
                    case CIRCLE_RADIUS /*{ENCODED_INT: 62}*/:
                        this.circleRadius = a.getDimensionPixelSize(attr, this.circleRadius);
                        break;
                    case CIRCLE_ANGLE /*{ENCODED_INT: 63}*/:
                        this.circleAngle = a.getFloat(attr, this.circleAngle);
                        break;
                    case WIDTH_PERCENT /*{ENCODED_INT: 69}*/:
                        this.widthPercent = a.getFloat(attr, 1.0f);
                        break;
                    case HEIGHT_PERCENT /*{ENCODED_INT: 70}*/:
                        this.heightPercent = a.getFloat(attr, 1.0f);
                        break;
                    case CHAIN_USE_RTL /*{ENCODED_INT: 71}*/:
                        Log.e(ConstraintSet.TAG, "CURRENTLY UNSUPPORTED");
                        break;
                    case BARRIER_DIRECTION /*{ENCODED_INT: 72}*/:
                        this.mBarrierDirection = a.getInt(attr, this.mBarrierDirection);
                        break;
                    case BARRIER_MARGIN /*{ENCODED_INT: 73}*/:
                        this.mBarrierMargin = a.getDimensionPixelSize(attr, this.mBarrierMargin);
                        break;
                    case CONSTRAINT_REFERENCED_IDS /*{ENCODED_INT: 74}*/:
                        this.mReferenceIdString = a.getString(attr);
                        break;
                    case BARRIER_ALLOWS_GONE_WIDGETS /*{ENCODED_INT: 75}*/:
                        this.mBarrierAllowsGoneWidgets = a.getBoolean(attr, this.mBarrierAllowsGoneWidgets);
                        break;
                    case UNUSED /*{ENCODED_INT: 76}*/:
                        Log.w(ConstraintSet.TAG, "unused attribute 0x" + Integer.toHexString(attr) + "   " + mapToConstant.get(attr));
                        break;
                    case ConstraintSet.CONSTRAINT_TAG /*{ENCODED_INT: 77}*/:
                        this.mConstraintTag = a.getString(attr);
                        break;
                    case ConstraintSet.CONSTRAINED_WIDTH /*{ENCODED_INT: 80}*/:
                        this.constrainedWidth = a.getBoolean(attr, this.constrainedWidth);
                        break;
                    case ConstraintSet.CONSTRAINED_HEIGHT /*{ENCODED_INT: 81}*/:
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (mapToConstant.get(attr)) {
                ...
                case CIRCLE_ANGLE /*{ENCODED_INT: 63}*/:
                    ...
                    break;
                case ANIMATE_RELATIVE_TO /*{ENCODED_INT: 64}*/:
                    c.motion.mAnimateRelativeTo = lookupID(a, attr, c.motion.mAnimateRelativeTo);
                    break;
                case TRANSITION_EASING /*{ENCODED_INT: 65}*/:
                    if (a.peekValue(attr).type != 3) {
                ...
                case DRAW_PATH /*{ENCODED_INT: 66}*/:
                    c.motion.mDrawPath = a.getInt(attr, 0);
                    break;
                case TRANSITION_PATH_ROTATE /*{ENCODED_INT: 67}*/:
                    c.motion.mPathRotate = a.getFloat(attr, c.motion.mPathRotate);
                    break;
                case PROGRESS /*{ENCODED_INT: 68}*/:
